...
Revision ID: 616dac240cc1
Revises: 
Create Date: 2023-04-09 10:09:44.006472
...
def upgrade():
    ...
    sa.Column('bot_token', sa.String(length=64), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('lane_switch_ts', sa.DateTime(), nullable=True),
    sa.Column('category', sa.Integer(), nullable=True),
    sa.Column('lane', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['category'], ['users.id'], ),
    sa.ForeignKeyConstraint(['lane'], ['lanes.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
